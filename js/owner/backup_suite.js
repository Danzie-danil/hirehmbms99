...
export async function generateFullBusinessBackup() {
    ...
    try {
        const rawData = await dbBackup.fetchFullBackupData(ownerId);
        const data = rawData || { sales: [], products: [], customers: [], expenses: [] };
        ...
        const backupData = {
            ...
            summary: {
                total_sales_records: data.sales.length,
