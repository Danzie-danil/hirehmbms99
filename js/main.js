...
import './owner/backup_engine.js';
import './owner/stock_sheet_engine.js';
...
const safeCreateIcons = (options = {}) => {
    try {
        ...
        console.warn('[Lucide] safeCreateIcons notice:', e);
    }
};
...
window.renderLoader = Utils.renderPremiumLoader;
window.triggerAppRefresh = Utils.triggerAppRefresh;
window.clearAllCache = Utils.clearAllCache;
window.downloadBarcodeImage = Utils.downloadBarcodeImage;
window.printBarcodeLabel = Utils.printBarcodeLabel;
