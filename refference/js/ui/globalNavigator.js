...
export function getNavigatorItems() {
    ...
    if (role === 'branch' || role === 'cashier') {
        ...
        items.push(
            ...
            { category: 'Main Navigation', title: 'Stock Transfers & Requests', subtitle: 'Request stock from central warehouse or branches', icon: 'truck', keywords: 'transfers dispatch stock request restock', action: () => window.switchView?.('requests') },
            ...
            { category: 'Main Navigation', title: 'Customer Loyalty & Points', subtitle: 'Reward points, badges & discounts', icon: 'award', keywords: 'loyalty points rewards membership', action: () => window.switchView?.('loyalty') },
